    ...
    def run(self):
        ...
        try:
            ...
            if not page_token:
                ...
                log_error(actor, message, location="FacebookPhotoPostPublisher.run")
                return message
            ...
            if response.status_code >= 400 or data.get("error"):
                ...
                log_error(
                    actor,
                    message,
                    location="FacebookPhotoPostPublisher.run",
                    context={"code": error.get("code"), "subcode": error.get("error_subcode")},
                )
                return message
            ...
            log_error(actor, exc, location="FacebookPhotoPostPublisher.run")
            return f"Error publishing photo post: {exc}"
